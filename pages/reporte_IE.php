...
foreach ($alumnos_sede as $alumnos_sede)
{
	...
	$id_informe = $periodo.'-'.$alumnos_sede['id_alumno'];
	...
	*/
	...
	$date_periodo = $object-> Read_fecha_periodo_reporte($periodo);
	...
	echo "periodo_str: ".$periodo_str."<br>";
	echo "periodo_str2: ".$periodo_str2."<br>";
	...
	foreach ($asignaturas_grupo as $asignaturas_grupo)
	{
		...
		$desc_logro = $object->Read_logros_asignatura_periodo($alumnos_sede['id_alumno'],$id_anio_lectivo,$asignaturas_grupo['id_asignatura'],$periodo);
