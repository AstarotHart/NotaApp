...
<?php 
    ...
    {
        $cabecera = $object_docente_grupo->Read_cabecera_asig_grupo($id_grupo,$id_sede);
        ...
        if (isset($id_grupo))
        {
            $alumnos_grupo = $object_docente_grupo->Read_docente_asig_grupo($id_sede);
            $res_grupos  = " ";      
        }
                    ...
                    <div class="card">
                        <div class="body" style="padding-top: 10px;">
                                ...
                                <!-- enviar de manera oculta datos id_asignatura e id_anio_lectivo --> 
                                    <input type="text" class="form-control" name="id_grupo_old" value="<?php echo $id_grupo; ?>">
